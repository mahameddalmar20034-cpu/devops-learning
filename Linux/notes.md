...
- This is used to show the kernet is a script -  `#!/bin/bash`
- This is makes it executable -`chmod +x Day1.txt`
- This executes the file  - `./Day1.txt`
-This changers the ownership to a new group -`sudo chown :netdev Day1.txt`
